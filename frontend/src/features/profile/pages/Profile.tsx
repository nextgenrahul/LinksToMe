...
const ProfilePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-black text-gray-100">
      <div className="mx-auto max-w-[480px] px-3 md:max-w-[935px] md:px-6">

        {/* Profile Header */}
        <header className="pt-6 pb-4 text-center md:flex md:items-start md:gap-10 md:text-left md:pt-10 md:pb-6">
          
          {/* Profile Image */}
          <img
            src="https://via.placeholder.com/150/000/fff?text=R"
            alt="Profile"
            className="mx-auto mb-4 h-[120px] w-[120px] rounded-full border-4 border-neutral-800 object-cover md:mx-0 md:h-[150px] md:w-[150px]"
          />
          ...
          <div className="w-full">
            ...
            {/* Username */}
            <div className="flex items-center justify-center gap-2 text-2xl font-semibold md:justify-start">
              rahul_shakya.0001
            ...
            {/* Bio */}
            <div className="mx-auto mt-2 max-w-[90%] whitespace-pre-line text-sm leading-relaxed md:mx-0">
              Code is an illusion, only logic is real. Seeking ultimate truth
              in the digital cosmos.
              {"\n"}Sannyasi Bande
            </div>

            {/* Stats */}
            <div className="mt-6 flex justify-around text-sm md:justify-start md:gap-14">
              <div className="text-center">
                <span className="block text-lg font-bold">3</span>
                <span className="text-gray-400">posts</span>
              </div>
              <div className="text-center">
                <span className="block text-lg font-bold">158</span>
                <span className="text-gray-400">followers</span>
              </div>
              <div className="text-center">
                <span className="block text-lg font-bold">273</span>
            ...
            <div className="mt-6 flex justify-center gap-3 md:justify-start">
              <button className="rounded-lg border border-neutral-700 px-6 py-2 text-sm font-semibold hover:bg-neutral-900 transition">
                Edit Profile
              </button>
              <button className="rounded-lg border border-neutral-700 px-6 py-2 text-sm font-semibold hover:bg-neutral-900 transition">
                View Archive
        ...
        {/* Saved Header */}
        <div className="border-t border-neutral-800 py-3 text-sm font-semibold text-gray-400">
        ...
        <div className="grid grid-cols-3 gap-1 pb-20">
          ...
          {[
            ...
            >
              <img
                src={`https://via.placeholder.com/300/111/aaa?text=${encodeURIComponent(
                  item
                )}`}
                alt={item}
          ...
          {/* New Collection */}
          <div className="aspect-square flex flex-col items-center justify-center gap-2 rounded-lg bg-neutral-800 text-blue-500 font-semibold">
      ...
      <nav className="fixed bottom-0 left-0 right-0 flex h-14 items-center justify-around border-t border-neutral-800 bg-black md:hidden">
